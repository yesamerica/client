...
const NoAccount = (props) => {
  ...
  return (
    <div className="noAccount">
        ...
        <div id="company-onboarding" onClick={actType}><img src={companyIcon} alt="Building Icon"/><h2>I am a company looking to set up events for employees</h2></div>
        <div id="provider-onboarding" onClick={actType}><img src={providerIcon} alt="Microphone Icon"/><h2>I am a speaker or service provider looking to get out in my community</h2></div>
        <div id="individual-onboarding" onClick={actType}><img src={individualIcon} alt="User Icon"/><h2>I am an individual or group member looking to set up an event</h2></div>
        <div id="sponsor-onboarding" onClick={actType}><img src={sponsorIcon} alt="Gift Icon"/><h2>I am a sponsor who wants to support my community</h2></div>
        <BackButton {...props}/>
    </div>
  );
};
